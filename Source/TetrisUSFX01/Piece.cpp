...
APiece::APiece()
{
    ...
    //FVector NewLocation(0.0f, -20.0f, 100.0f);
    //SceneComponent->SetRelativeLocation(NewLocation);
    ...
    //    FConstructorStatics(): 
    //        Color_0(TEXT("Material'/Game/Mesh/M_CobbleStone_Pebble.M_CobbleStone_Pebble'")) , Color_1(TEXT("Material'/Game/Mesh/M_CobbleStone_Rough.M_CobbleStone_Rough'"))
    //        , Color_2(TEXT("Material'/Game/Mesh/M_Ground_Grass.M_Ground_Grass'")) , Color_3(TEXT("Material'/Game/Mesh/M_Metal_Rust.M_Metal_Rust'"))
    //        , Color_4(TEXT("Material'/Game/Mesh/M_Wood_Oak.M_Wood_Oak'")) , Color_5(TEXT("Material'/Game/Mesh/M_Wood_Walnut.M_Wood_Walnut'"))
    //        , Color_6(TEXT("Material'/Game/Stylized_Egypt/Materials/building_materials/M_block.M_block'")) , Color_7(TEXT("Material'/Game/Stylized_Egypt/Materials/props_materials/M_props.M_props'"))
    //    {
    //    }
    //    
...
void APiece::SpawnBlocks()
{
    ...
    AFactoryNivel1* FabricaNivel1 = GetWorld()->SpawnActor<AFactoryNivel1>(AFactoryNivel1::StaticClass());
  ...
  /*      AbloqueRedondo* Br;
        ...
        switch (i) {
        case 0:
            Br = FabricaNivel1->CrearBloque("temporal");
            Br->AttachToActor(this, FAttachmentTransformRules::KeepRelativeTransform);
            Br->SetActorRelativeLocation(FVector(0.0, YZ.first, YZ.second));
            Blocks.Add(Br);
            break;
        case 1:
            Br = FabricaNivel1->CrearBloque("normal");
            Br->AttachToActor(this, FAttachmentTransformRules::KeepRelativeTransform);
            Br->SetActorRelativeLocation(FVector(0.0, YZ.first, YZ.second));
            Blocks.Add(Br);
            break;
        case 2:
            Br = FabricaNivel1->CrearBloque("postDest");
            Br->AttachToActor(this, FAttachmentTransformRules::KeepRelativeTransform);
            Br->SetActorRelativeLocation(FVector(0.0, YZ.first, YZ.second));
            Blocks.Add(Br);
            break;
